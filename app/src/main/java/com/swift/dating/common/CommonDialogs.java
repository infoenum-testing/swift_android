...
public class CommonDialogs {
    ...
    public static final String[] timeTokenArr = new String[]{"time_token_1", "time_token_5", "time_token_10", "time_token_20"};
    public static final String[] crushTokenArr = new String[]{"crush_token_1", "crush_token_5", "crush_token_10", "crush_token_20"};
    public static final String[] vipTokenArr = new String[]{"bgviptoken1", "bgviptoken5", "bgviptoken10", "bgviptoken20"};
    public static final String[] PremiumArr = new String[]{"premium_1", "premium_3", "premium_6", "premium_12"};
    ...
    public static final Double[] PremiumPriceArr = new Double[]{9.99, 29.99, 39.99, 59.99};
